...
if dia_format =="lunes" or dia_format=="martes" or dia_format=="miercoles":
    print("Se romara examen")
    numero_de_aprobados=int(input("Ingrese el numero de alumno aprobados: "))
    numero_de_desaporbados=int(input("Ingrese el numero de desaprobados: "))
    total_de_alumnos= numero_de_aprobados+numero_de_desaporbados
    procentajes_de_desaprobados=(numero_de_desaporbados*100)/total_de_alumnos
    print(f"El porcentade de alumnos desaprobado el dia lunes es de %{procentajes_de_desaprobados} ")
    procentajes_de_aprobados=(numero_de_aprobados)*100/total_de_alumnos
    print(f"El porcentade de alumnos aprobado el dia lunes es de %{procentajes_de_aprobados} ")
else:
